...
$sql= "UPDATE lawyers SET firstName='$firstName', lastName='$lastName', phoneNumber='$phoneNumber', email='$email', license='$license', specialized='$specialized', path='$path', advisoryPrice='$advisoryPrice', image='$image' WHERE id='$id'";
